...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	// 1. 입력한 비밀번호를 암호화한다.
    	    	...
    	    	System.out.println("________________________________cccccc queryId = "+loginVO);
    	    	...
    	    	if (loginVO != null && !loginVO.getId().equals("") && !loginVO.getPassword().equals("")) {
    	    		...
    	    		loginVO = new LoginVO();
    	    		System.out.println("__________________________________________________eeeeee queryId = "+loginVO.toString());
    	    	}
    	    	System.out.println("________________________________re queryId = "+loginVO.getId());
    	    	return loginVO;
    }
